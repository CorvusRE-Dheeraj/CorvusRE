...
// own "Forgot password?" flow against the same Supabase project this app's
// own accounts live in. ?screen=forgot opens straight on that screen
// instead of plain sign-in.
