...
// and switch-property-plan (an in-place tier change) — the one real, formal
// receipt email a customer gets right after a real card charge or credit, so
// they never have to guess what was deducted or wonder if a charge on their
// statement is legitimate. Requires the RESEND_API_KEY secret (shared with
